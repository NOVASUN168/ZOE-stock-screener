...
FIELDS = [
    ...
    # 资金 10%
    "main_fund_flow", "northbound", "institution_change",
    # 风险 5%（软因子）
...
NUMERIC = {
    ...
    "pledge_ratio", "goodwill_ratio", "total_score", "target_price",
...
def list_all(conn, industry=None, style=None, min_score=None) -> list:
